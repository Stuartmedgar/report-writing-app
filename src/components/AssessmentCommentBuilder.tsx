...
interface AssessmentCommentBuilderProps {
  onSave: (comment: AssessmentComment) => void;
  onCancel: () => void;
  existingComment?: AssessmentComment;
}
...
function AssessmentCommentBuilder({ onSave, onCancel, existingComment }: AssessmentCommentBuilderProps) {
  ...
  const handleSave = () => {
    if (!commentName.trim()) {
      alert('Please enter a name for this assessment comment');
      return;
    }
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb' }}>
      <header style={{ 
        ...
        <h1 style={{ 
          ...
          {existingComment ? 'Edit' : 'Create'} Assessment Comment
        </h1>
      </header>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '32px' }}>
            <label style={{ 
              ...
              Assessment Comment Name
            </label>
            <input
              type="text"
              placeholder="e.g. End of Unit Test, Class Assessment, Practical Exam..."
              value={commentName}
            ...
            <div style={{ 
              ...
              <label style={{ 
                ...
                <input 
                  type="radio"
                  value="outOf"
                  checked={scoreType === 'outOf'}
                  onChange={(e) => setScoreType(e.target.value as 'outOf' | 'percentage')}
                  style={{ transform: 'scale(1.1)' }}
                />
                <span>Score out of (e.g. 15 out of 20)</span>
              </label>
            ...
            {scoreType === 'outOf' && (
              <div>
                <label style={{ 
                  ...
                  Default maximum score (teachers can change this when writing reports):
                </label>
                <input
                  type="number"
...
export default AssessmentCommentBuilder;